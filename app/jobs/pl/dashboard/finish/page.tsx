...
export default function FinishJobsDashboardPage() {
  ...
  // Fixed filter for Finished Jobs
  const FINISHED_JOB_FILTER = { segmentName: 'JobStatusCode', operator: 'eq', value: 'C' };
